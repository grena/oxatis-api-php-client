...
/**
 * Class representing QuotationDetailBundledItemsBaseEntityType
 *
 *
 * XSD Type: QuotationDetailBundledItemsBaseEntity
 */
class QuotationDetailBundledItemsBaseEntityType extends OxatisEntityType
{

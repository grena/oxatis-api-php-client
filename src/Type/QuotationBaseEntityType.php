...
/**
 * Class representing QuotationBaseEntityType
 *
 *
 * XSD Type: QuotationBaseEntity
 */
class QuotationBaseEntityType extends QuotationSummaryEntityType
{
    ...
    /**
     * @var \Heavymind\Oxatis\ApiClient\Type\QuotationTaxDetailEntityType[] $quotationTaxDetails
     */
    private $quotationTaxDetails = null;
     ...
     */
    public function addToQuotationTaxDetails(QuotationTaxDetailEntityType $item)
    {
        $this->quotationTaxDetails[] = $item;
        return $this;
    }

    /**
     * isset quotationTaxDetails
     *
     * @param int|string $index
     * @return bool
     */
    public function issetQuotationTaxDetails($index)
    {
        return isset($this->quotationTaxDetails[$index]);
    }

    /**
     * unset quotationTaxDetails
     *
     * @param int|string $index
     * @return void
     */
    public function unsetQuotationTaxDetails($index)
    {
        unset($this->quotationTaxDetails[$index]);
    }

    /**
     * Gets as quotationTaxDetails
     *
    ...
    /**
     * Sets a new quotationTaxDetails
     *
     * @param \Heavymind\Oxatis\ApiClient\Type\QuotationTaxDetailEntityType[] $quotationTaxDetails
     * @return self
     */
    public function setQuotationTaxDetails(array $quotationTaxDetails)
    {
        $this->quotationTaxDetails = $quotationTaxDetails;
        return $this;
    }

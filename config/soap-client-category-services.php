...
$wsdlUri = 'https://webservices.oxatis.com/webservices/HttpServices/SOAP/CategoryServices.asmx?WSDL';
...
$config = Config::create()
    ...
    ->setClientDestination('src/Services/CategoryServices')
    ->setClientName('CategoryServicesClient')
    ->setClientNamespace('Heavymind\Oxatis\ApiClient\Services\CategoryServices')
    ->setClassMapDestination('src/Services/CategoryServices')
    ->setClassMapName('CategoryServicesClassmap')
    ->setClassMapNamespace('Heavymind\Oxatis\ApiClient\Services\CategoryServices')
